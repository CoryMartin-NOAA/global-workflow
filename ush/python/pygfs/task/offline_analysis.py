...
class OfflineAnalysis(Task):
    ...
    def finalize(self) -> None:
        ...
        transfer_files.append([os.path.join(self.task_config.COMIN_ATMOS_ANALYSIS.replace('analysis', ''), f"{self.task_config.APREFIX_IN}seaice.5min.blend.grb"),
        ...
        transfer_files.append([os.path.join(self.task_config.COMIN_ATMOS_ANALYSIS.replace('analysis', ''), f"{self.task_config.APREFIX_IN}snogrb_t1534.3072.1536"),
